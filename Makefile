...
doctest :
	doctest -XCPP -DLANGUAGE_PTS_HAS_NAT -DLANGUAGE_PTS_HAS_NAT_PRIM -DLANGUAGE_PTS_HAS_BOOL -DLANGUAGE_PTS_HAS_BOOL_PRIM -DLANGUAGE_PTS_HAS_SIGMA -DLANGUAGE_PTS_HAS_EQUALITY -DLANGUAGE_PTS_HAS_PROP -DLANGUAGE_PTS_HAS_QUARKS -DLANGUAGE_PTS_HAS_FIXED_POINT --fast src/
...
doctest-all : doctest
	...
	doctest -XCPP -DLANGUAGE_PTS_HAS_FIXED_POINT --fast src/
